<?php
	...
	$merge_vars = array('FNAME'=>$_REQUEST[ 'contact-name' ], 'LNAME'=>$_REQUEST[ 'contact-name' ]);

	// Submit subscriber data to MailChimp
	// For parameters doc, refer to: http://apidocs.mailchimp.com/api/1.3/listsubscribe.func.php
	$retval = $api->listSubscribe( '6784b478298a46ab36a612aa46b8b62d-us1','831ab6ad71', $email, $merge_vars, 'html', false, true ,true, true);
